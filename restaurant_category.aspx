<%@ Page Title="" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="restaurant_category.aspx.cs" Inherits="restaurant_category" %>
 ...
 <div class="searchbox">
           ...
           <asp:Repeater ID="rescat" runat="server">
            ...
            <div style="width:100%;">
    			...
    			<div style="float:left;width:82px; height: 90px;">
    				<a rel="gallery" href="http://themes.themegoods.com/pluto_wp/wp-content/uploads/2011/09/Farfalle-With-Salmon.jpg">
                        ...
                        <!--<img class="frame" src="<%# DataBinder.Eval(Container.DataItem, "logopath")%>" />-->
    				</a>
    			</div>
